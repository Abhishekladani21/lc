    ...
    <div class="container">
        <form action="{{ url('users/store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="card-body card-block">
                <div class="form-group"><label class="pr-1 form-label">First Name</label> @error('fname')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                    <input type="text" id="exampleInputName2" name="fname"
                        class="form-control @error('fname')is-invalid @enderror" value="{{ old('fname') }}">
                </div>
                <div class="form-group"><label class="px-1 form-label">Last Name</label> @error('lname')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                    <input type="text" id="exampleInputEmail2" name="lname"
                ...
                <div class="form-group"><label class="pr-1 form-label">Date Of Birth </label>
                    @error('dob')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                    <input type="date" name="dob" class="form-control @error('fname')is-invalid @enderror"
                        value="{{ old('dob') }}">
                </div>
                ...
                <div class="form-group"><label class="pr-1 form-label">Description</label> @error('description')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
